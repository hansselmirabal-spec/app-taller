...
export const ALL_MODULES: ModuleDef[] = [
  ...
  { id: 'recursos',      label: 'Recursos',                description: 'Vehículos bloqueados esperando repuestos' },
  { id: 'seguimiento',   label: 'Seguimiento OTs',          description: 'Tracking y reportería de OTs del DMS' },
];
